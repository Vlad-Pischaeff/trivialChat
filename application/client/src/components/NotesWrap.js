...
export default function NotesWrap({ item, idx }) {
  ...
  return (
    <>
      ...
      {
        edit
          ? <TooltipWrap className="h-2rem" position="tip-left" tip="Save note...">
          ...
          : <TooltipWrap className="h-2rem" position="tip-left" tip="Edit note...">
      ...
      <TooltipWrap className="h-2rem" position="tip-left" tip="Delete note...">
